                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="name" name="order_number" type="text" placeholder="First Name" value="{{old('name')}}" required>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="last_name" name="order_ref_number" type="text" placeholder="Last Name" value="{{old('surname')}}" required>
                        </div>
                    </div>
                </div>
                <div class="row">
